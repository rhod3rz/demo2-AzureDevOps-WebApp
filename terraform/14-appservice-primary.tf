...
module "az_appservice_primary" {
  ...
  plan_name            = "pln-${var.environment}-${var.application_code}-${var.unique_id}-pri" # The plan name.
  webapp_name          = "app-${var.environment}-${var.application_code}-${var.unique_id}-pri" # The webapp name.
